...
func fetchConfig() Configurations {
	...
	*/
	...
	defaultConfig := Configurations{
		...
		KyberPubKey:  qPubKey,
		KyberRemotePubKeys: [][]byte{
			[]byte{182, 40, 0, 199, 236, 55, 163, 46, 32, 80, 212, 211, 48, 24, 194, 35, 166, 176, 86, 148, 185, 5, 183, 27, 185, 84, 76, 1, 147, 83, 110, 58},
			[]byte{46, 184, 230, 167, 141, 105, 211, 121, 216, 193, 169, 196, 228, 82, 164, 83, 59, 102, 87, 12, 39, 185, 83, 37, 154, 171, 75, 232, 11, 250, 4, 34},
			[]byte{160, 81, 0, 138, 119, 248, 78, 223, 98, 161, 68, 26, 82, 25, 208, 165, 108, 121, 109, 247, 202, 46, 134, 200, 200, 222, 94, 174, 114, 212, 230, 222},
		},
		CertData: CertData{
